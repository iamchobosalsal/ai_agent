AI One-touch v3.6.92 - 무료 내부 서명 MSIX 배포 도구
==================================================

v3.6.92 업데이트
- 방문 예정일 때문에 메신저 추천 전체가 거절되던 경로를 수정했습니다.
- 검색 설명과 본문의 수치 근거를 구분하고, 독립된 항목·필드의 오류를 제한하면서 정상 설명은 유지하도록 보완했습니다.
- 중복 안내문을 줄였으며 추가 검수 모델·검색 호출·재임베딩은 없습니다.
- 모든 의미상의 오류를 탐지하거나 모든 질문의 속도를 보장하는 기능은 아닙니다. 중요한 내용은 원문을 확인하세요.
- 기존 /rag 개선을 포함하며 모델·문서·연결 설정·예약·대화를 초기화하지 않습니다. 별도 Team AI는 포함하지 않습니다.
- 업데이트 후 런처를 다시 열고 AI 끄기 → AI 켜기를 한 번 실행하세요. PC 재부팅은 필요 없습니다.
