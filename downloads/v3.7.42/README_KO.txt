AI One-touch Beginner v3.7.42 - 무료 내부 서명 MSIX 배포 도구
==================================================
...
3. 새 런처의 v3.7.42 확인 → AI 켜기 → 모델 서버와 Hermes·메신저 연결 시작 완료 확인.
주의: BAT 설치나 창 재실행만으로는 실행 중인 Hermes가 갱신되지 않을 수 있습니다.
이미 설치했다면 AI 끄기 → AI 켜기를 실행하세요. PC 재부팅·초기화·제거·모델 재다운로드는 필요하지 않습니다.
기존 모델·문서·대화·예약·연결 설정을 지우지 마세요. 상세 내용은 RELEASE_NOTES_v3.7.42.md를 참고하세요.
